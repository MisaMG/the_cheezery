...
class ProductosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var listviewColdDrinks: ListView = findViewById(R.id.listview) as ListView
    ...
    fun agregarProducto(){
        coldDrinks.add(Product("Caramel Frap", R.drawable.caramelfrap, "Caramel syrup meets coffe, milk and ice and whipped cream and buttery caramel sauce layer the love on top.",5.00))
